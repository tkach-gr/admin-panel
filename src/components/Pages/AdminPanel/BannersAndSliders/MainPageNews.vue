      ...
      <div class="card-body__top">
        ...
        <div class="card-body__item">
          <div class="custom-control custom-switch">
            <input v-model="isEnabled" type="checkbox" class="custom-control-input" id="mainPageNewsSwitch">
            <label class="custom-control-label" for="mainPageNewsSwitch"></label>
          </div>
        </div>
      </div>
...
<script>
import MainPageNewsBlock from './MainPageNewsBlock.vue';
